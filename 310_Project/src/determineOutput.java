...
public class determineOutput {
	...
	public String respond(String data, Personality personality) {
		...
		String responseBack = "";
		/*
		 * Create ArrayLists to store the arraylists received from methods created in Personality class.
		 * Once we receive the ArrayLists, we can call the method(converting arraylist to string) as per given user input.
		 */
